...
import { FileText, ArrowRight, Database, Play, Download } from 'lucide-react';
  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8 z-10">
        ...
        >
          <a href="https://www.linkedin.com/in/mariam-gbadegesin" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors" aria-label="LinkedIn">
